...
\section{Metodologia de Pesquisa}
    ...
    \subsection{Objetivos}
        Atualmente existem poucos estudos sobre o comportamento do PSO com componentes dinâmicos em cenários mono objetivos, principalmente em problemas com o FJSP.\hfill\vspace{\onelineskip}
        
        Com as implementações feitas nesse trabalho se espera não uma análise crua de números e métricas de desempenho, mas sim ideias de como certas alterações afetam o desempenho do algoritmo, e quais são as tendências de mudanças.\hfill\vspace{\onelineskip}
...
\section{Arquitetura}
    ...
    \subsection{Espaço de Soluções}
        %% Interlúdio %%
            ...
            Um espaço de soluções pode ser representado de diversas maneiras, como listas e grafos, mas em problemas de optimização normalmente se usa uma representação na forma de uma matriz.\hfill
        %% Fim do [Interlúdio] %%
        ...
        \subsubsection{Gráficos de análise}
            ...
            Esses gráficos se mostraram extremamente uteis ao decorrer do desenvolvimento deste trabalho, servindo para validar detectar erros na função de inicialização do espaço de soluções.\hfill\vspace{\onelineskip}
        ...
        \subsubsection{Influencia na Solução}
            ...
            Já que esse ponto se destaca muito entre seus vizinhos o algoritmo pode ficar preso nesta região, pois a média local sempre tende para o ponto onde está o mínimo local.\hfill\vspace{\onelineskip}
        ...
        \subsubsection{Implementação}
            ...
            \subsubsubsection{Inicialização}
                Um ponto importante percebido na implementação é como sera inicializado o \textit{array} onde será armazenado o espaço de soluções.\hfill\vspace{\onelineskip}
    ...
    \subsection{Partícula}
        ...
        \subsubsection{Implementação}
            ...
            Para fazer uma melhor movimentação foi optado por não usar uma variável de direção, mas sim uma variável que guarda a última posição onde a partícula esteve.\hfill
            ...
            Função \textbf{\code{fill\_with\_random\_values}} que gera uma posição inicial e uma velocidade aleatória para a partícula.\hfill\vspace{\onelineskip}
            
            Função \textbf{\code{evaluate\_value}} que faz o cálculo do valor de \textit{fitness} da atual posição e a comparação do valor com o atual valor de $pBest$ e atualiza o $pBest$ caso o novo valor seja melhor.\hfill\vspace{\onelineskip}

            Função \textbf{\code{update\_position}} que faz a movimentação da partícula.\hfill\vspace{\onelineskip}
            ...
            Em implementações de código aberto como a já citada \textit{PySwarms}, também se utiliza uma representação de classe, porém sem nenhuma responsabilidade de cálculo de \textit{fitness}, atualização de posição ou de preenchimento de valores aleatórios na partícula.\hfill
        ...
        \subsubsection{Movimentação}
            ...
            Então nesse trabalho foi desenvolvido um método de movimentação baseado em cálculos vetoriais que elimina esses problemas de movimentação além de facilitar a implementação de novos pontos de comparação (além do $pBest$ e $gBest$) para o cálculo da nova posição.\hfill
    ...
    \subsection{População}
        ...
        Os parâmetros como o tamanho da população são definidos nas configurações do algoritmo. Todas as funções utilizadas na geração dos indivíduos seguem o padrão de distribuição uniforme.\hfill\vspace{\onelineskip}
