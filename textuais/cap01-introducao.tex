...
A nova abordagem e a abordagem padrão do PSO foram testadas em diversos cenarios e com tamanhos diferentes de espaços de solução e foram obtidos resultados positivos e promisorres, tendo melhores resultados e com uma menor taxa de variancia, demostrando que essa abordagem de inercia dinamica proposta traz uma contribuição significativa para o algoritmo PSO aplicado no problema de FJSP.
