...
Todos os \textit{datasets} dos problemas A, B, C e D são os mesmos utilizados nos \textit{benchmarks} de \cite{Kacem2002}.
%
...
desvio padrão $40\%$ menor em relação à abordagem padrão.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
