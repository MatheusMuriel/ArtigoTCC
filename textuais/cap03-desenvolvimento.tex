...
\end{itemize}
%
O tamanho do espaço de soluções é calculado pela raiz quadrada do arrendamento para baixo do tamanho da população elevado ao coeficiente populacional, representado pela equação 
...
\begin{itemize}
    \item \code{coeficente\_populacional = $2.3$}: Gera um mapa de $50 \times 50$
    \item \code{coeficente\_populacional = $2.5$}: Gera um mapa de $70 \times 70$
