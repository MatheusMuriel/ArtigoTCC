...
\section{Problemas de Agendamento}
    ...
    \subsection{Problema de Job Shop — JSP}
        ...
        \subsubsubsection{Instancia de um Problema}
            Na figuraX é possível ver um exemplo de uma instância de problema de \textit{Job Shop}. A onde existem duas maquinas $(M_1, $ e $M_2)$, dois \textit{jobs} $(J_1, $ e $J_2)$ e que cada \textit{job} possui duas operações $(O_{j,1} $ e $O_{j,2})$.\newline
            Sendo assim:\newline
    ...
    \subsection{Problema de Job Shop Flexível — FJSP}
        ...
        \subsubsubsection{Instancia de um Problema}
            ...
            A representação a seguir tem um exemplo de problema com dez maquinas $(M_1, M_2, M_3, ..., M_10)$ e dez \textit{jobs} $(J_1, J_2, J_3, ..., J_10)$ e cada \textit{job} possuindo três operações $(O_{j1}, O_{j2} e O_{j3})$.\newline

            Cada índice $ji$ da Tabelax representa o tempo $T_{ji}$ de execução de $O_{ji}$, para cada máquina $M_k$, sendo $k = 1,... m$, onde $m$ é a quantidade de máquinas e $n$ a quantidade de jobs, ou seja, nesse exemplo $n = 10$ e $m = 10$.\newline
        ...
        \subsubsubsection{Solução}
            ...
            \begin{itemize}
                ...
                \item Cada \textit{job} utiliza no mínimo duas máquinas para ser executado, por exemplo: o $J_{1}$ é executado nas máquinas $M_1 , M_3, M_4$.
